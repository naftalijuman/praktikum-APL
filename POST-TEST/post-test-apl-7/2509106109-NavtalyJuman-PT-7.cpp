...
void tambahData(AkunCOC *akun, int *jumlahData){
    ...
    try{
        ...
        if(akun[*jumlahData].townHall < 0){
            throw "Town Hall tidak boleh negatif!";
        }

        cout<<"Trophy : ";
        cin>>akun[*jumlahData].trophy;

        if(akun[*jumlahData].trophy < 0){
            throw "Trophy tidak boleh negatif!";
        }
...
void ubahData(AkunCOC *akun, int jumlahData){
    ...
    try{
        ...
        if(nomorUbah <= 0 || nomorUbah > jumlahData){
            throw "Nomor data tidak valid!";
        }
...
void hapusData(AkunCOC *akun, int *jumlahData){
    ...
    try{
        ...
        if(nomorHapus <= 0 || nomorHapus > *jumlahData){
            throw "Nomor hapus tidak valid!";
        }
...
int main(){
    ...
    do{
        try{
            ...
            cout<<"5. Sorting Nama"<<endl;
            cout<<"6. Sorting Trophy"<<endl;
